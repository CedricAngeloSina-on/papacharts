                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="grid pb-2">
                          ...
                          <FormDescription>
                            Select the chart type you want to render.
                          </FormDescription>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="grid pb-2">
                          ...
                          <FormDescription>
                            Choose the axes you want to include.
                          </FormDescription>
                          <div className="min-h-5">
                            <FormMessage />
                          </div>
